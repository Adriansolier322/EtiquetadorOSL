...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add'])) {
    try {
        $insertStmt = $pdo->prepare("INSERT INTO pc (
            ...
            wifi, bluetooth, obser, description // Added description here
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"); // Added one more '?' for description
        ...
        $insertStmt->execute([
            ...
            $_POST['bluetooth'],
            $_POST['obser'],
            $_POST['description'] // Added description here
        ]);
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($pc['obser']); ?></td> <td class="actions">
